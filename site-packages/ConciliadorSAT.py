    ...
    def extractInfoDiarios(self):
        ...
        try:
            ...
            for mes in self.meses:
                ...
                self.wriErr.addMensaje("debug", "empece a leer diarios")
                ...
                for line in file:
                    ...
                    if (line.split(',')[1] != "datos_poliza_anio" and line[0:3] != ",,,"):
                        ##print(line)
                        UUIDDiario = line.split(',')[32].strip()  ##[:-1]
                ...
                file.close()
                self.wriErr.addMensaje("debug", "me quede en: " + line)
        except Exception as err:
            print("error")
            input(line)
            self.wriErr.addMensaje("error", err)
