...
class Conciliador:
    ...
    def __init__(self, agnc, fch, rutaArch):
    ...
    def createReportPDF(self,cuenta):
        ...
        try:
            dst = self.directorio + "\\" + self.fecha[8:] + "\\" + cuenta + "_al" + self.fecha[
                                                             8:] + self.fecha[
                                                                5:7] + self.fecha[
                                                                   2:4] + ".pdf"
    ...
    def recorreResCorto2(self):
        ...
        try:
            for cuenta in self.resTodo.keys():
                ...
                dst = self.directorio + "\\" + self.fecha[8:] + "\\C_" + cuenta + "_al" + self.fecha[
                                                                                        8:] + self.fecha[
                                                                                              5:7] + self.fecha[
                                                                                                     2:4] + ".csv"
    ...
    def recorreRes():
        ...
        try:
            ...
            for cuenta in self.resTodo.keys():
                ...
                dst = self.directorio + "\\" + self.fecha[8:] + "\\REP_" + cuenta + "_al" + self.fecha[
                                                                                        8:] + self.fecha[
                                                                                              5:7] + self.fecha[
                                                                                                     2:4] + ".csv"
    ...
    def extractInfo(self):
        ...
        try:
            continuar = True
            srcICAAV = self.directorio + "\\ICAAV " + self.agencia + ".csv"
            srcBancos = self.directorio + "\\Bancos " + self.agencia + ".csv"
            srcSaldos = self.directorio + "\\Saldos " + self.agencia + ".csv"
            try:
