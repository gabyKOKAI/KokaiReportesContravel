    ...
    def createReport(self, type):
        ...
        try:
            ...
            if not ".csv" in src:
                ...
                for line in file1:
                    if (line[0:3] != ",,," and line.split(',')[0].strip()!="CLAVE CLIENTE" and line.split(',')[21] !="N/A"):
                        linea = line
                        if(type == "old"):
            ...
            self.addMensaje("info", "Recuerda que: Las cantidades deben tener formato General. El documento no deben tener titulos ni deben existir comas ´,´ en el archivo CSV antes de guardarlo")
