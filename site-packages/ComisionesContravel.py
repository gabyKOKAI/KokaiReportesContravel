					...
					if(renglon["clases"]==['']):
						...
						if(renglon["paisOrigen"] == "MEX" and renglon["paisDestino"] == "EUA"):
							if(renglon["dicAerolineas"] == {'AM': 'AM', 'DL': 'DL'} or renglon["dicAerolineas"] == {'AM': 'AM'}):
								...
								res = "0%"
							if ("V" in renglon["clases1"] or "E" in renglon["clases1"]):  ##and renglon["paisOrigen"] == "MEX"):
								res = "0%"
						else:
							...
							if("V" in renglon["clases1"] or "R" in renglon["clases1"]): ##and renglon["paisOrigen"] == "MEX"):
								res = "0%"
					...
					if(renglon["clases"]==['']):
						...
						'''
							...
							if("N" in renglon["clases1"]):
								res = "3%"
							'''
				elif (renglon["lineaAerea"] == "WS"):
						if (renglon["clases"] == ['']):
							res = self.regresaComision(renglon)
						else:
							if (renglon["interlineal"] == False):
								res = self.regresaComision(renglon)
							else:
								res = "0%"
