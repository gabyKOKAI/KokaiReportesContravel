...
class ComisionesContravel:
	...
	def regresaComision(self, renglon):
		...
		try:
			...
			##print(strAux)
			##print(renglon["lineaAerea"])
			##print(self.dicExcepciones)
			...
			elif (renglon["lineaAerea"] + renglon["ciudadOrigen"] + "***" in self.dicExcepciones):
				res = self.dicExcepciones[renglon["lineaAerea"] + renglon["ciudadOrigen"] + "***"]
